...
The **Workspaces** tab lists all workspaces under your account.
...
Click **Delete** next to a workspace. 

:::danger
Deleting a workspace permanently removes it and all resources inside it. This cannot be undone.
:::
